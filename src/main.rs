...
fn main() -> Result<(), String> {
    ...
    entities.push(Entity::new(Generator::generate_terrain()));
    ...
    for event in event_pump.poll_iter() {
        match event {
            ...
            Event::MouseButtonDown {
                ...
                entities.push(Entity::new(Mesh {
                    lines: vec![Line {
                        color: Color::RGB(80, 65, 40),
                        points: (
                            Point::new(intersect_point.x(), intersect_point.y()),
                            Point::new(intersect_point.x(), intersect_point.y() - 12),
                        ),
                    }],
                }));
            }
